...
class TestHomework3(ApiBase):
    def test_create_delete_campaign(self):
        ...
        assert self.check_campaign_in_campaigns_list(campaign_id=campaign_id) is True
    ...
    def test_create_delete_segment(self):
        ...
        assert self.check_segment_in_segment_list(segment_id=segment_id) is True
    ...
    def test_create_delete_segment_and_data_source(self):
        ...
        assert self.check_segment_in_segment_list(segment_id=segment_id) is True
        assert self.check_groups_in_data_sources(data_source_id=source_id) is True
        self.delete_segment(segment_id=segment_id)
